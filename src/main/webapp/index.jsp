...
<div class="info_container">
    <div class="info">
        ...
        <p class="info_about_quiz">Квизы — это интерактивные викторины, которые позволяют вам проверить свои знания, развлекаться и учиться одновременно. Они могут быть использованы для развлечения на вечеринках, обучения в учебных заведениях или как инструмент маркетинга для бизнеса.</p>
    </div>
    <img class="index_img_1" src="img/index_img_1.png" alt="index_img_1">
