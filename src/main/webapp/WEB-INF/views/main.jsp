...
<header class="header">
    ...
    <div class="header_link_container">
        <a class="header_link" href="<c:url value='/create-quiz'/>">Создать квиз</a>
        <a class="header_link" href="<c:url value='/user'/>">Профиль</a>
...
<div class="container">
    ...
    <div class="button-container">
        <a href="<c:url value="/start-game"/>" class="button">Создать игру</a>
    </div>
</div>
...
<div class="container">
    ...
    <form action="<c:url value='/main'/>" method="POST" id="connect-to-game-form">
